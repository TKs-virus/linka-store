  ...
  return (
    <div className="py-16 space-y-16">
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          {[
            { label: "Live Events", value: "350+", icon: Calendar, color: "from-red-400 to-orange-400" },
            { label: "Monthly Attendees", value: "25K+", icon: Users, color: "from-green-400 to-emerald-400" },
            { label: "Venues", value: "50+", icon: MapPin, color: "from-blue-400 to-cyan-400" },
            { label: "Streaming Hours", value: "2K+", icon: Eye, color: "from-purple-400 to-pink-400" },
          ].map((stat, index) => (
            <motion.div
              key={index}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                      ...
                      {[...Array(getDaysInMonth(currentMonth, currentYear))].map((_, index) => {
                        ...
                        return (
                          <motion.button
                            ...
                            whileHover={{ scale: hasEvent ? 1.1 : 1.05 }}
                            whileTap={{ scale: 0.95 }}
                          >
                            {day}
                            {hasEvent && (
                              <motion.div 
                                className="w-1 h-1 bg-red-400 rounded-full mx-auto mt-1"
                      ...
                      >
                        ...
                        <div className="space-y-2">
                          {getEventsForDate(new Date(selectedDate).getDate()).map(event => (
                            <motion.div 
                              key={event.id} 
                              className="text-sm p-3 bg-white/5 rounded-lg hover:bg-white/10 transition-colors cursor-pointer"
                              whileHover={{ scale: 1.02 }}
                            >
                              <div className="text-white font-medium">{event.title}</div>
                              <div className="text-white/70">{event.time} • {event.venue}</div>
                              <div className="text-red-400 text-xs mt-1">{event.price.split(' - ')[0]}</div>
                            </motion.div>
                          ))}
                        </div>
                      </motion.div>
              ...
              <div className="lg:col-span-2 space-y-6">
                {upcomingEvents.map((event) => (
                  ...
                  >
                    <Card className="group cursor-pointer bg-white/5 backdrop-blur-sm border border-white/20 hover:border-red-500/50 transition-all duration-300 hover:shadow-2xl overflow-hidden">
                      <CardContent className="p-0">
                        <div className="md:flex">
                          <div className="md:w-1/3 relative">
                            ...
                            {/* Ticket Count */}
                            <div className="absolute bottom-3 left-3 bg-green-500/20 backdrop-blur-sm text-green-400 px-2 py-1 rounded-lg text-xs font-bold">
          ...
          <TabsContent value="live" className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {liveEvents.map((event) => (
                ...
                >
                  <Card className="group cursor-pointer bg-gradient-to-br from-green-500/10 to-emerald-500/10 backdrop-blur-sm border border-green-500/30 hover:border-green-500/50 transition-all duration-300 overflow-hidden">
                    <CardContent className="p-0">
                      <div className="relative">
                        ...
                        />
                        <motion.div 
                          className="absolute top-2 left-2 bg-red-500 text-white px-3 py-1 rounded-full text-xs font-bold flex items-center"
                        ...
                        <div className="absolute bottom-2 right-2 bg-black/70 backdrop-blur-sm text-white px-2 py-1 rounded-lg text-xs flex items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {upcomingEvents.filter(event => event.category === "concerts").map((event) => (
                <motion.div
                  ...
                  whileHover={{ scale: 1.02, y: -5 }}
                >
                  <Card className="group cursor-pointer bg-gradient-to-br from-purple-500/10 to-pink-500/10 backdrop-blur-sm border border-purple-500/30 hover:border-purple-500/50 transition-all duration-300 overflow-hidden">
                    <CardContent className="p-0">
                      <div className="relative">
                        <img
                          src={event.image}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {upcomingEvents.filter(event => event.category === "comedy").map((event) => (
                <motion.div
                  ...
                  whileHover={{ scale: 1.02, y: -5 }}
                >
                  <Card className="group cursor-pointer bg-gradient-to-br from-yellow-500/10 to-orange-500/10 backdrop-blur-sm border border-yellow-500/30 hover:border-yellow-500/50 transition-all duration-300 overflow-hidden">
                    <CardContent className="p-6">
                      <div className="flex space-x-4">
                        <img
                          src={event.image}
                          alt={event.title}
                          className="w-24 h-32 object-cover rounded-lg group-hover:scale-105 transition-transform"
                        />

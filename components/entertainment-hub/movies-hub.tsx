...
const trendingMovies = [
  ...
  },
  {
    ...
    description: "High-octane thriller featuring international cast and stunning visuals",
  ...
  },
  {
    ...
    description: "Futuristic adventure with groundbreaking special effects",
    director: "Maria Rodriguez",
    cast: ["Alex Turner", "Lisa Wong", "James Wilson"],
...
const streamingServices = [
  {
    ...
    trial: "7 days free",
    logo: "https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=100&h=50&fit=crop"
  },
  {
    id: 2,
    name: "Showmax",
    ...
    trial: "14 days free",
    logo: "https://images.unsplash.com/photo-1611162616475-46b635cb6868?w=100&h=50&fit=crop"
  },
  {
    id: 3,
...
export function MoviesHub() {
  ...
  const getMoviesForCategory = () => {
    switch (activeTab) {
      case "local":
        return trendingMovies.filter(movie => movie.isLocal)
      case "streaming":
    ...
    <div className="py-16 space-y-16">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        {[...Array(10)].map((_, i) => (
          ...
          >
            <Film className="h-6 w-6 text-purple-400/20" />
          </motion.div>
        ))}
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">
            Discover the best of Zambian cinema and stream your favorite content from around the world
          </p>
        </motion.div>
        ...
        >
          {[
            { label: "Movies Available", value: "2,500+", icon: Film, color: "from-purple-400 to-violet-400" },
            { label: "Local Productions", value: "150+", icon: Award, color: "from-green-400 to-emerald-400" },
            { label: "Streaming Hours", value: "50K+", icon: Clock, color: "from-blue-400 to-cyan-400" },
            { label: "Active Viewers", value: "18K+", icon: Users, color: "from-orange-400 to-red-400" },
          ].map((stat, index) => (
            <motion.div
              key={index}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {trendingMovies.map((movie) => (
                <motion.div
                  ...
                  className="relative"
                >
                  <Card className="group cursor-pointer bg-white/5 backdrop-blur-sm border border-white/20 hover:border-purple-500/50 transition-all duration-500 hover:shadow-2xl hover:shadow-purple-500/20 overflow-hidden">
                      ...
                      <div className="relative overflow-hidden aspect-[2/3]">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                          ...
                          >
                            <Button
                              size="lg"
                              className="bg-gradient-to-r from-purple-500 to-violet-500 hover:opacity-90 text-white shadow-lg rounded-full w-16 h-16"
                            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {streamingServices.map((service) => (
                <motion.div
                  ...
                  whileHover={{ scale: 1.02, y: -5 }}
                >
                  <Card className="group cursor-pointer bg-gradient-to-br from-red-500/10 to-pink-500/10 backdrop-blur-sm border border-red-500/30 hover:border-red-500/50 transition-all duration-300">
                    <CardContent className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {watchlist.map((item) => (
                  <motion.div
                    ...
                    whileHover={{ scale: 1.02, y: -5 }}
                  >
                    <Card className="group cursor-pointer bg-gradient-to-br from-orange-500/10 to-yellow-500/10 backdrop-blur-sm border border-orange-500/30 hover:border-orange-500/50 transition-all duration-300 overflow-hidden">
                      <CardContent className="p-0">
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-8">
        <motion.div
          ...
          transition={{ duration: 0.6 }}
        >
          <h3 className="text-3xl font-bold text-white mb-8 text-center">Director Spotlight</h3>
          <Card className="bg-gradient-to-r from-purple-500/20 to-violet-500/20 backdrop-blur-sm border border-purple-500/30 overflow-hidden">
            <CardContent className="p-8">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  />
                  <h4 className="text-2xl font-bold text-white mb-2 text-center">James Mwanza</h4>
                  <p className="text-purple-400 text-center mb-4">Award-Winning Director</p>
                ...
                <div>
                  <p className="text-white/80 mb-6 leading-relaxed">
                    "My mission is to tell authentic Zambian stories that resonate with both local and international audiences. 
                    Cinema has the power to bridge cultures and preserve our heritage for future generations."
                  </p>
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      <span className="text-white/70">Latest Film:</span>
                      <span className="text-white">The Copper Chronicles</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-white/70">Box Office:</span>
                      <span className="text-white">ZMW 2.5M</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-white/70">Awards:</span>
                      <span className="text-white">12 International</span>
                    </div>
                  </div>
                  <Button
                    className="w-full mt-6 bg-gradient-to-r from-purple-500 to-violet-500 hover:opacity-90"
                    size="sm"
                  >
